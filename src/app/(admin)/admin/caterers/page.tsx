...
export default function CaterersPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Caterers</h1>
        <p className="text-sm text-gray-500">{totalElements} registered caterers</p>
      </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b border-gray-200 sticky top-0">
                <tr>
                  <th className="text-left font-medium text-gray-500 px-4 py-3">Business Name</th>
                  ...
                  <th className="text-left font-medium text-gray-500 px-4 py-3">Cuisine Types</th>
                  <th className="text-left font-medium text-gray-500 px-4 py-3">Plate Range</th>
                ...
                {loading ? (
                  ...
                  caterers.map((c) => (
                    <tr key={c.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-gray-600">{c.primaryCity || '-'}</td>
                      <td className="px-4 py-3">
                      ...
                      <td className="px-4 py-3 text-gray-600">
                        {c.minPlateCount && c.maxPlateCount
                          ...
                          : '-'}
                        {c.pricePerPlate && (
                          <span className="block text-xs text-gray-400">₹{c.pricePerPlate}/plate</span>
                        )}
                      </td>
