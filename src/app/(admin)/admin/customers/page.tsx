    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">{totalElements} registered customers</p>
        </div>
      </div>
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b border-gray-200 sticky top-0">
                <tr>
                  ...
                  <th className="text-left font-medium text-gray-500 px-4 py-3">Verified</th>
                ...
                {loading ? (
                  ...
                  customers.map((customer) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-gray-500">{dayjs(customer.createdAt).format('DD MMM YYYY')}</td>
                    </tr>
                  ))
                )}
              </tbody>
