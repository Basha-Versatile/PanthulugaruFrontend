...
export default function PhotographersPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Photographers</h1>
        <p className="text-sm text-gray-500 dark:text-[#E8DDD0]/60">{totalElements} registered photographers</p>
      </div>
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 dark:bg-[#241C16] border-b border-gray-200 dark:border-[#D4AF37]/10 sticky top-0">
                <tr>
                  ...
                  <th className="text-left font-medium text-gray-500 dark:text-[#E8DDD0]/60 px-4 py-3">Specializations</th>
                ...
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={6} className="text-center py-12 text-gray-400 dark:text-[#E8DDD0]/40">
                      <Camera className="h-8 w-8 mx-auto mb-2 text-gray-300 dark:text-[#E8DDD0]/30" />
                      No photographers found.
                    </td>
                  </tr>
                ) : (
                  photographers.map((p) => (
                    <tr key={p.id} className="hover:bg-gray-50 dark:hover:bg-[#241C16] transition-colors">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-400 dark:text-[#E8DDD0]/40">{p.email}</p>
                          </div>
                        </div>
                      </td>
                      <td className="px-4 py-3 text-gray-600 dark:text-[#E8DDD0]/70">{p.phone}</td>
                      <td className="px-4 py-3 text-gray-600 dark:text-[#E8DDD0]/70">{p.primaryCity || '-'}</td>
                      <td className="px-4 py-3">
                      ...
                      <td className="px-4 py-3 text-gray-500 dark:text-[#E8DDD0]/60">{dayjs(p.createdAt).format('DD MMM YYYY')}</td>
                    </tr>
                  ))
                )}
              </tbody>
